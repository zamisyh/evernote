                    ...
                    <div className="flex justify-between card-title">
                        ...
                        <div className="flex">
                            { note.favorite === false ? 
                                ...
                                <svg onClick={() => updateFavoriteNoteHandler(note)} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-red-500 bi bi-heart-fill" viewBox="0 0 16 16">
